  ...
  return (
    <>
      ...
      <div className="section2">
        <div className="experience-page-conatiner">
          <Row
            className={`experience-row text-light  ${
          ...
          >
            ...
            >
              <Row>
                <h2 className="text-ceneter">TRAINING</h2>
              </Row>
              <br />
              <br />
            ...
            >
              ...
              <ul>
                <li>
                  ...
                  di framework moderni come React e TypeScript.
                </li>
                <li>
                  <span>Back-End:</span> <br /> Approfondimento delle competenze
                  in Java Enterprise e SpringBoot, con integrazione di database
                  PostgreSQL.
                </li>
                <li>
              ...
              <div>
                ...
                <ul>
                  <li>
                    ...
                    <br /> La mia formazione al Politecnico mi ha fornito una
                    solida base tecnica, che ho successivamente applicato con
                    successo nel mondo dello sviluppo web. Le conoscenze
                    acquisite in materie scientifiche e informatiche sono stati
                    i pilastri su cui sto costruendo la mia carriera.
                  </li>
                  <li>
                    ...
                    importante rimanere aggiornato e aperto alle nuove
