...
const TopAboutMe = () => {
  const [linguage, setLinguage] = useState(false);
  ...
  return (
    <>
      <Row className="justify-content-center mt-2">
        {" "}
        <Col className="d-flex col-10 col-lg-9 ">
      ...
      <Row className="justify-content-center text-light top-about-container pt-5 align-content-center">
        <Col className="col-10  col-lg-7 text-center text-box text-focus-in ">
